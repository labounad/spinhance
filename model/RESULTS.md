...
| 64k·022 | medium 10M | 64k | canonical matrix + surrogate-spectral | 0.064 / 0.91 / 0.916 / 0.928 | superseded |
| 64k·025 | medium 10M | 64k | matrix, **shift wt 2×**, WSD LR | 0.037 / 0.59 / 0.94 / 0.945 | superseded (by light-025) |
| 64k·026 | medium 10M | 64k | 025 + **peak channel** + **soft-equiv** | 0.0361 / 0.644 / 0.941 / 0.950 | done (≈025) |
| **500k·025** (light) | medium 10M | **500k** PubChem (random) | 025 recipe, e80 | **0.036 / 0.51 / 0.969 / 0.969** (best ep43) | **production** |
| 500k·026 (light) | medium 10M | **500k** PubChem (random) | 026 recipe, e80 | running (best ep10: 0.059 / 0.89 / 0.935 / 0.959) | running |
| 1M·025 (xl) | **xl 57M** | **1M** PubChem | 025 recipe, **stable LR** | running, cleared ep7 (best ep5: 0.053 / 0.73 / 0.948 / 0.962) | running |
| 1M·026 (xl) | **xl 57M** | **1M** PubChem | 026 recipe, **stable LR** | running, cleared ep7 (best ep7: 0.056 / 0.70 / 0.949 / 0.960) | running |

**Production model = 500k·025** (a.k.a. light-025) (500k PubChem, 0.036 ppm / 0.51 Hz / F1 0.969 / deg-bal 0.969,
